 ...
 * @Last Modified time: 2021-03-08 16:45:15
 */
import set from "lodash.set";
import { Message } from "element-ui";
import lodashGet from "lodash.get";
import encapsulation from "axios-encapsulation/src";
import EncapsulationClass from "axios-encapsulation/src";
...
const encapsulationInstance: EncapsulationClass = new encapsulation({
  axiosRetryConfig: {
...
const { axiosInstance }: any = encapsulationInstance;
const { get, post, put } = axiosInstance;

export default axiosInstance;
export const deletes = axiosInstance.delete;
export { get, post, put };
